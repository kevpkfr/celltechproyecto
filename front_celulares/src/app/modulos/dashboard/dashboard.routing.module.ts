...
import { ComentDetailComponent } from "./comentarios/coment-detail/coment-detail.component";
import { ContactanosComponent } from "./contactanos/contactanos.component";
import { DetailComponent } from "./contactanos/detail/detail.component";
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'comentarios/:id', component: ComentDetailComponent},
      {path: 'contactanos', component: ContactanosComponent},
      {path: 'contactanos/:id', component: DetailComponent},
    ]
  }
];
